...
def chat_fn(message, history, workflow_state, session_data):
    ...
    if time_since_start > timedelta(minutes=8):
        ...
        return "Session timed out after 8 minutes. Thank you for participating!", workflow_state, session_data

    # Check if conversation is complete - block further messages
    if workflow_state.conversation_complete:
        return "Thank you for participating! The conversation is now complete.", workflow_state, session_data
